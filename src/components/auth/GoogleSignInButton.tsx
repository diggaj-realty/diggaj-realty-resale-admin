...
/** Google "G" logo — inline so no external asset/network request is needed. */
function GoogleLogo() {
  return (
...
export default function GoogleSignInButton({ callbackUrl = '/dashboard' }: { callbackUrl?: string }) {
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-center gap-2.5 rounded-full border py-2.5 text-sm font-medium transition-colors hover:bg-black/[0.02] disabled:opacity-60"
